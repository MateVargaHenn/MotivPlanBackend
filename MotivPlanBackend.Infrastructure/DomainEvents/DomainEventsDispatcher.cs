...
namespace MotivPlanBackend.Infrastructure.DomainEvents;
...
internal sealed class DomainEventsDispatcher(IServiceProvider serviceProvider) : IDomainEventsDispatcher
{
    ...
    private abstract class HandlerWrapper
    {
        ...
        public static HandlerWrapper Create(object handler, Type domainEventType)
        {
            ...
            return (HandlerWrapper)(Activator.CreateInstance(wrapperType, handler) ?? throw new InvalidOperationException($"Failed to create handler wrapper for type {wrapperType.Name}"));
        }
    }
